...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        ExecutorService responseSendingThreadPool = Executors.newFixedThreadPool(10); 

        try {
            ClientManager clientManager = new ClientManager(PORT, commandProcessor, authService, responseSendingThreadPool);
