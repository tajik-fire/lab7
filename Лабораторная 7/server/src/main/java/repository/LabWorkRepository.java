        ...
        try (Connection connection = databaseManager.getConnection();
            ...
            while (resultSet.next()) {
                ...
                if (disciplineName != null) {
                    // Discipline lecture_hours and self_study_hours are not stored in the database table labworks.
                    // Initialize with default values or adjust Discipline model if these are needed for persistence.
